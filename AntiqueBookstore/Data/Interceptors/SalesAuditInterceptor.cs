...
namespace AntiqueBookstore.Data.Interceptors
{
    public class SalesAuditInterceptor : ISaveChangesInterceptor
    {
        ...
        // ISSUE: Entity Framework Core
        // Actual Id value will only be generated by the database during the INSERT statement,
        // EF assigns a temporary negative value to the Id property (e.g. -2147482647)
        // The database returns the generated Id (11) back. EF updates the Id property in memory,
        // replacing the temporary value (-2147482647) with the real value (11).
        // The state of the entity changes from Added to Unchanged. SavedChanges (SavedChangesAsync) triggered.
